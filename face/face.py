...
def face(image_path_1, image_path_2) -> bool:
    ...
    id3face.FaceLibrary.load_model(
        modelPath,
        id3face.FaceModel.FACE_DETECTOR_4B,
        id3face.ProcessingUnit.CPU
    )
    id3face.FaceLibrary.load_model(
        modelPath,
        id3face.FaceModel.FACE_ENCODER_9A,
        id3face.ProcessingUnit.CPU
    )
    ...
    image1 = id3face.Image.from_file(
        image_path_1, 
        id3face.PixelFormat.BGR_24_BITS
    )
    image2 = id3face.Image.from_file(
        image_path_2, 
        id3face.PixelFormat.BGR_24_BITS
    )
    print("Done.\n")
